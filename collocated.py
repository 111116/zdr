...
render_collocated_kernel = derive_render_kernel(direct_collocated)
render_collocated_backward_kernel = derive_render_backward_kernel(direct_collocated_backward)